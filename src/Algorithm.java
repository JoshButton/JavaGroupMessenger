...
public class Algorithm {
    ...
    /**
     * Expands right to 48 bits, xor the expanded right with the subkey, and use
     * S Boxes
     *
    ...
    /**
     * Takes a string of 8 characters and converts it to its ascii equivalent
     * with 8 bits per char
     *
     ...
     * @param IV the initialization vector that will be xor with first 64 bit of
     * plaintext
     * @param isDecrypt true if decrypting, false if encrypting
     * @return
     */
